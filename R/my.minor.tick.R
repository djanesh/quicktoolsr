...
#' @description This is function to add minor ticks in the base graphics
#' @name my.minor.tick
#' @title Add minor ticks in base graphics
#' @param nx
#' nx is the number of ticks in x direction
#' @param ny
#' ny is the number of ticks in y direction
#' @param tick.ratio
#' tick.ratio is the ratio of the ticks
#' @param side
#' specify the side where you want to add the minor ticks
#' @export
my.minor.tick <-
